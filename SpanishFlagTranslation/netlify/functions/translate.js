...
let languageAliases = {};
try {
  // relative to this file: ../../language_aliases.json
...
exports.handler = async function(event) {
  try {
    ...
    // Try to extract a quoted phrase from the ORIGINAL text
    ...
    // Fallback: translate whole input to explicit target or default to 'es'
